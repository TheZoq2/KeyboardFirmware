...
const Z::Keymap<FULL_WIDTH, HEIGHT> DEFAULT_LAYER_MAP = Z::init_keymap<FULL_WIDTH, HEIGHT>(DEFAULT_LAYER);
const Z::Keymap<FULL_WIDTH, HEIGHT> LOWER_LAYER_MAP = Z::init_keymap<FULL_WIDTH, HEIGHT>(LOWER_LAYER);
...
Z::KeyboardStateManager<LAYER_AMOUNT, FULL_WIDTH, HEIGHT> init_state_manager()
{
    ...
    const Z::Keymap<FULL_WIDTH, HEIGHT>* keymaps[LAYER_AMOUNT] = {
        &DEFAULT_LAYER_MAP,
        &LOWER_LAYER_MAP,
        &DEFAULT_LAYER_MAP //TODO: Add a raised layer
    };
