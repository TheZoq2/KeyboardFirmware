...
const Z::Keycode DEFAULT_LAYER[HEIGHT][FULL_WIDTH] = {
    ...
    {MODIFIERKEY_SHIFT, KEY_Z,                    KEY_X, KEY_C,          KEY_V, KEY_B,         KEY_N, KEY_M,                   KEY_COMMA, KEY_PERIOD,          KEY_SLASH, KEY_QUOTE},
     ...
     {MODIFIERKEY_CTRL, MODIFIERKEY_ALT, KEY_LEFT_BRACE, Z::FN_WM, Z::FN_LOWER, KEY_SPACE, Z::FN_VIM, Z::FN_RAISE, MODIFIERKEY_RIGHT_ALT, KEY_RIGHT_BRACE,          MODIFIERKEY_RIGHT_CTRL, Z::FN_SPECIAL}
};
...
const Z::Keycode LOWER_LAYER[HEIGHT][FULL_WIDTH] = {
    ...
    {MODIFIERKEY_SHIFT, KEY_Z,                    KEY_X, KEY_C,          KEY_V, KEY_B,                 KEY_N, KEY_M,                   KEY_COMMA, KEY_PERIOD,          KEY_SLASH, KEY_NON_US_BS},
     ...
     {MODIFIERKEY_CTRL, MODIFIERKEY_ALT, KEY_LEFT_BRACE, Z::FN_WM, Z::FN_LOWER, KEY_SPACE, MODIFIERKEY_SHIFT, Z::FN_RAISE, MODIFIERKEY_RIGHT_ALT, KEY_RIGHT_BRACE,          MODIFIERKEY_RIGHT_CTRL, Z::FN_SPECIAL}
};
